...
{ //6
  theme:'html', 
  question: 'После присуждения премии вскрывался конверт, в котором находилась записка с фамилией автора. Каково же было изумление, когда автором блестящей работы оказалась русская женщина. Кто же была эта женщина-ученый?', 
  image:'',
